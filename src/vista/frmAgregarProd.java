...
public class frmAgregarProd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlDetalle.add(txtMarcaProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 110, -1));
    ...
    private void btnAgregarBdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarBdActionPerformed
        ...
        if ((IdProd.length() == 0) || (marca.length() == 0) || (cantidad.length() == 0) || (lote.length() == 0) || (fecha.length() == 0) || (totalVeh.length() == 0)) {
            JOptionPane.showMessageDialog(null, "Faltan datos...");
        }else{
        String guardarSQl = "insert into vehiculos (veh_IDvehiculo, veh_marca,veh_cantidad,veh_lote,veh_fecha,veh_total) values () "
